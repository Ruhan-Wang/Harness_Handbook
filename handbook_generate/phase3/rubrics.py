...
TIER1_RUBRIC = Rubric(
    tier="tier1",
    purpose=(
        "Let a COMPLETE NOVICE understand the Harness's purpose and what it "
    ...
    criteria=(
        Criterion("purpose_clarity", "gate", 0.25,
                  "Clearly answers what the Harness is for, why it exists, what "
                  "problem it solves. The reader learns why it exists."),
        Criterion("what_it_does", "gate", 0.20,
                  "Conveys, at a high level, what it actually does (an LLM "
                  "driving a terminal, looping see-think-act until done)."),
        ...
        Criterion("shape_fidelity", "soft", 0.20,
                  "The mental model is faithful to the real shape (loop until a "
                  "twice-confirmed completion or budget exhaustion; a "
                  "summarization side flow)."),
