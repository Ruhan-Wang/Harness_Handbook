...
Examples
--------
# Reproduce the legacy terminus_2 run (Python):
python3 run_phase1.py --lang python \
    --source-root ../../harbor/src/harbor/agents/terminus_2 \
    --files terminus_2.py,tmux_session.py,terminus_json_plain_parser.py,\
terminus_xml_plain_parser.py,asciinema_handler.py,__init__.py \
    --out out/terminus_2
